    ...
    <SafeAreaView>
      ...
      >
        <View style={tw`flex-1 bg-white w-full`}>
          ...
          {/* Footer */}
          <View style={tw`p-4`}>
            {!visible ? <TouchableOpacity style={tw`bg-black p-4 rounded-md mb-4`} onPress={() => router.push('/workerDetail')}>
              <Text style={tw`text-white text-center`}>Register Now</Text>
            </TouchableOpacity> : <TouchableOpacity style={tw`bg-black p-4 rounded-md mb-4`} onPress={() => router.push('/RegisterasAdmin')}>
              <Text style={tw`text-white text-center`}>Register as Admin</Text>
            </TouchableOpacity>}
            <TouchableOpacity style={tw`bg-gray-200 p-4 rounded-md`} onPress={()=>router.push('/contactScreen')}>
