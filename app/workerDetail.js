...
import { View, Text, TouchableOpacity, ScrollView, TextInput, Modal, FlatList, Image, Alert, SafeAreaView } from "react-native";
        ...
        <SafeAreaView>
            ...
            >
                <View style={tw`flex-row items-center mb-4 bg-white p-4`}>
                    ...
                    <Text style={tw`text-xl font-black flex-1 text-center`}>Become A Worker</Text>
                </View>
                ...
                <View style={tw`flex-1 px-4`}>
                    ...
                    <TouchableOpacity style={tw`bg-black p-4 rounded-md mb-4`} onPress={submitHandler}>
